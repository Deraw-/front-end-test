...
let defaultLang = window.localStorage.getItem('lang') || navigator.language.substr(0, 2) || 'en';
...
const i18n = new VueI18n({
	locale: defaultLang,
	fallbackLocale: 'en', // By default, fallback to French if translation isn't found
